...
type Niks3 struct {
	...
	Hostname      string                 `protobuf:"bytes,3,opt,name=hostname" json:"hostname,omitempty"`
	IsTesting     bool                   `protobuf:"varint,4,opt,name=is_testing,json=isTesting" json:"is_testing,omitempty"`
	MainStorePath string                 `protobuf:"bytes,5,opt,name=main_store_path,json=mainStorePath" json:"main_store_path,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Niks3) GetIsTesting() bool {
	if x != nil {
		return x.IsTesting
	}
	return false
...
func (x *Niks3) GetMainStorePath() string {
	if x != nil {
		return x.MainStorePath
	}
	return ""
}
...
type Niks3Status struct {
	...
	IsTesting      bool                   `protobuf:"varint,5,opt,name=is_testing,json=isTesting" json:"is_testing,omitempty"`
	MainStorePath  string                 `protobuf:"bytes,6,opt,name=main_store_path,json=mainStorePath" json:"main_store_path,omitempty"`
	ManualDownload bool                   `protobuf:"varint,7,opt,name=manual_download,json=manualDownload" json:"manual_download,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *Niks3Status) GetIsTesting() bool {
	if x != nil {
		return x.IsTesting
	}
	return false
...
func (x *Niks3Status) GetMainStorePath() string {
	if x != nil {
		return x.MainStorePath
	}
	return ""
...
func (x *Niks3Status) GetManualDownload() bool {
	if x != nil {
		return x.ManualDownload
	}
	return false
}
...
type Store struct {
	...
	// A prepared manual deployment, persisted before asking the operator.
	PendingDeploymentUuid      string `protobuf:"bytes,12,opt,name=pending_deployment_uuid,json=pendingDeploymentUuid" json:"pending_deployment_uuid,omitempty"`
	PendingDeploymentOperation string `protobuf:"bytes,13,opt,name=pending_deployment_operation,json=pendingDeploymentOperation" json:"pending_deployment_operation,omitempty"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *Store) GetPendingDeploymentUuid() string {
	if x != nil {
		return x.PendingDeploymentUuid
	}
	return ""
}

func (x *Store) GetPendingDeploymentOperation() string {
	if x != nil {
		return x.PendingDeploymentOperation
	}
	return ""
}
...
type Event_Fetched struct {
	...
	// For niks3, polling may update metadata without downloading the closure.
...
func (x *Event_Fetched) GetPrepare() bool {
	if x != nil {
		return x.Prepare
	}
	return false
...
const file_pkg_protobuf_services_proto_rawDesc = "" +
	...
	"\tOperation\x12/\n" +
	"\x13operation_submitted\x18\x01 \x01(\tR\x12operationSubmitted\"\xca\x13\n" +
	"\x05Event\x12G\n" +
	...
	"deployment\x1a5\n" +
	"\fManagerState\x12%\n" +
	"\x05state\x18\x01 \x01(\v2\x0f.protobuf.StateR\x05state\x1a\xef\x01\n" +
	"\aFetched\x12\x18\n" +
	"\aupdated\x18\x01 \x01(\bR\aupdated\x12\x1a\n" +
	"\bverified\x18\x02 \x01(\bR\bverified\x12\x18\n" +
	"\aprepare\x18\x05 \x01(\bR\aprepare\x12Q\n" +
	...
	"\x10main_branch_name\x18\f \x01(\tR\x0emainBranchName\"\xa2\x01\n" +
	"\x05Niks3\x12\x17\n" +
	...
	"\n" +
	"is_testing\x18\x04 \x01(\bR\tisTesting\x12&\n" +
	"\x0fmain_store_path\x18\x05 \x01(\tR\rmainStorePath\"\x98\x02\n" +
	...
	"\n" +
	"is_testing\x18\x05 \x01(\bR\tisTesting\x12&\n" +
	"\x0fmain_store_path\x18\x06 \x01(\tR\rmainStorePath\x12'\n" +
	"\x0fmanual_download\x18\a \x01(\bR\x0emanualDownload\"^\n" +
	"\x06Source\x12!\n" +
	...
	"\x0esuspend_reason\x18\x02 \x01(\tR\rsuspendReason\"\xdd\x05\n" +
	"\x05Store\x126\n" +
	...
	"\x17deployment_any_capacity\x18\v \x01(\x05R\x15deploymentAnyCapacity\x126\n" +
	"\x17pending_deployment_uuid\x18\f \x01(\tR\x15pendingDeploymentUuid\x12@\n" +
	"\x1cpending_deployment_operation\x18\r \x01(\tR\x1apendingDeploymentOperation2\xea\x03\n" +
	"\x05Comin\x125\n" +
	"\bGetState\x12\x16.google.protobuf.Empty\x1a\x0f.protobuf.State\"\x00\x129\n" +
	"\x05Check\x12\x16.google.protobuf.Empty\x1a\x16.google.protobuf.Empty\"\x00\x129\n" +
...
var file_pkg_protobuf_services_proto_depIdxs = []int32{
	...
	41, // 80: protobuf.Comin.Check:input_type -> google.protobuf.Empty
	41, // 81: protobuf.Comin.Fetch:input_type -> google.protobuf.Empty
	41, // 82: protobuf.Comin.Suspend:input_type -> google.protobuf.Empty
	41, // 83: protobuf.Comin.Resume:input_type -> google.protobuf.Empty
	2,  // 84: protobuf.Comin.Confirm:input_type -> protobuf.ConfirmRequest
	41, // 85: protobuf.Comin.Events:input_type -> google.protobuf.Empty
	0,  // 86: protobuf.Comin.DeploymentLatestSubmit:input_type -> protobuf.Operation
	9,  // 87: protobuf.Comin.GetState:output_type -> protobuf.State
	41, // 88: protobuf.Comin.Check:output_type -> google.protobuf.Empty
	41, // 89: protobuf.Comin.Fetch:output_type -> google.protobuf.Empty
	41, // 90: protobuf.Comin.Suspend:output_type -> google.protobuf.Empty
	41, // 91: protobuf.Comin.Resume:output_type -> google.protobuf.Empty
	41, // 92: protobuf.Comin.Confirm:output_type -> google.protobuf.Empty
	1,  // 93: protobuf.Comin.Events:output_type -> protobuf.Event
	41, // 94: protobuf.Comin.DeploymentLatestSubmit:output_type -> google.protobuf.Empty
